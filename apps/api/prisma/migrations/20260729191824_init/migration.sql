-- CreateEnum
CREATE TYPE "RoleName" AS ENUM ('GUEST', 'CUSTOMER', 'VENDOR', 'AFFILIATE', 'SUPPORT', 'EDITOR', 'MANAGER', 'ADMIN', 'SUPER_ADMIN', 'DEVELOPER');

-- CreateEnum
CREATE TYPE "VendorStatus" AS ENUM ('PENDING', 'APPROVED', 'SUSPENDED', 'REJECTED');

-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('PHYSICAL', 'DIGITAL', 'SUBSCRIPTION', 'LICENSE', 'DOWNLOADABLE', 'SOFTWARE', 'SERVICE', 'BUNDLE', 'GIFT_CARD', 'MEMBERSHIP', 'COURSE');
...
-- CreateEnum
CREATE TYPE "PaymentProvider" AS ENUM ('STRIPE', 'PAYSTACK', 'FLUTTERWAVE', 'PAYPAL');
...
CREATE TABLE "vendors" (
    ...
    "commissionPct" DECIMAL(5,2) NOT NULL DEFAULT 10.0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "deletedAt" TIMESTAMP(3),
