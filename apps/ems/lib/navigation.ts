...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "nav.academics.aiTeaching" },
      { key: "nav.academics.liveClassroom" },
      { key: "nav.academics.timetable" },
  ...
  },
  {
    ...
    icon: "examination",
    items: [
      { key: "nav.examination.setup", roles: STAFF },
      ...
      { key: "nav.examination.results" },
      { key: "nav.examination.resultTemplates", roles: ADMIN_ONLY },
      { key: "nav.examination.reportCards" },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "nav.settings.paymentGateways" },
      { key: "nav.settings.communicationGateways" },
